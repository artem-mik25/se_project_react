...
// Coordinates for your chosen location (e.g. New York)
export const COORDS = {
  lat: 40.7128,
  lon: -74.0060,
};

// Your OpenWeatherMap API key from .env (VITE_WEATHER_API_KEY)
export const WEATHER_API_KEY = import.meta.env.VITE_WEATHER_API_KEY;

// Default clothing items provided by the project spec
...
// Map a temperature to a weather type
